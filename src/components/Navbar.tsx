    ...
    >
      ...
      <div className="px-4 py-3 flex flex-wrap items-center justify-between gap-x-4 gap-y-2">
        <Link href="/" className="flex items-center gap-2.5 min-w-0">
          ...
          {/* Not "CDS English": the wordmark sat directly above a General
              Knowledge test as soon as the second subject landed. */}
          <span className="font-bold text-ink tracking-tight truncate">CDS Prep</span>
        </Link>
